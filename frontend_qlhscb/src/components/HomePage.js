            ...
            <Col lg={6}>
              <div className="hero-content">
                <h1 className="hero-title">
                  Chào mừng đến với <span className="highlight">QLHoSoCanBo</span>
                </h1>
                <p className="hero-subtitle">
                  Hệ thống quản lý hồ sơ cán bộ hiện đại trên nền tảng Blockchain
                </p>
                <p className="hero-description">
                  Ứng dụng công nghệ Hyperledger Fabric để quản lý thông tin cán bộ một cách 
                  minh bạch, an toàn và hiệu quả. Theo dõi toàn bộ thông tin nhân sự từ 
                  khi vào làm đến các thay đổi chức vụ và lương.
                </p>
                {user && (
            ...
            <Col md={4}>
              <Card className="feature-card">
                <Card.Body>
                  ...
                  <Card.Title>Quản lý hồ sơ cán bộ</Card.Title>
                  <Card.Text>
                    Theo dõi thông tin chi tiết về từng cán bộ: họ tên, chức vụ, 
                    phòng ban, trình độ, lương và địa chỉ.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
            <Col md={4}>
              <Card className="feature-card">
                <Card.Body>
                  ...
                  <Card.Text>
                    Tạo báo cáo chi tiết về tình hình nhân sự, thống kê theo 
                    phòng ban, chức vụ và trình độ.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
