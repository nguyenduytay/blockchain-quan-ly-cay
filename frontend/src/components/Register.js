                ...
                {error.includes('blockchain') || error.includes('Chaincode') ? (
                  <div className="mt-3">
                    ...
                    <ol className="mb-2">
                      ...
                      <li>Deploy chaincode: <code>./network.sh deployCC -ccn qlcaytrong -ccp ../chaincode/qlcaytrong/javascript -ccl javascript</code></li>
                      <li>Kiểm tra backend đang chạy: <code>cd ~/backend && npm start</code></li>
                    </ol>
